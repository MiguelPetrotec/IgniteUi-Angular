...
export class LanguageTranslationModule {
  constructor(
    ...
    this.translate.addLangs(['pt', 'en', 'fr', 'ur', 'es', 'it', 'fa', 'de', 'zh-CHS','dev']);
    this.translate.setDefaultLang('pt');
    // this.translate.setDefaultLang('es');

    const browserLang = this.translate.getBrowserLang();
    this.translate.use(browserLang.match(/pt|en|fr|ur|es|it|fa|de|zh-CHS|dev/) ? browserLang : 'pt');
    // this.translate.use(browserLang.match(/pt|en|fr|ur|es|it|fa|de|zh-CHS/) ? browserLang : 'en');
    // this.translate.use(browserLang.match(/pt|en|fr|ur|es|it|fa|de|zh-CHS/) ? browserLang : 'en');
